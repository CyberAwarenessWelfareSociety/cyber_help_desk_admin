    ...
    <div className={styles.container}>
      <div className={styles.card}>
        <div className={styles.topBarRow}>
          <h2 className={styles.cardTitle}>API Hit Logs</h2>
          ...
          <table className={styles.table}>
            <thead>
              <tr className={styles.tableHeader}>
                ...
                <th>Status</th>
                <th>Cost</th>
                <th>Before Hit Balance</th>
                <th>After Hit Balance</th>
                <th>Latency</th>
                <th>Created At</th>
                <th>Vendor Name</th>
              ...
              {loading ? (
                ...
                <>
                  ...
                  <tr>
                    <td>Sneha Patel</td>
                    <td>VerifyAadhaar</td>
                    <td>{'{"aadhaar":"xxxx-xxxx-1234"}'}</td>
                    <td>Failed</td>
                    <td>0.8</td>
                    <td>200</td>
                    <td>199.2</td>
                    <td>450ms</td>
                    <td>2025-08-01 15:10</td>
                    <td>IDCheck Solutions</td>
                    <td>3500</td>
                    <td>3499.2</td>
                  </tr>
                </>
